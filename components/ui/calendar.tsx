        ...
        {(date) => (
          <CalendarCellRac
            ...
            className={cn(
              ...
              // Range-specific styles (invalid → quiet monotone: muted, not red)
              isRange &&
                "data-[selected]:rounded-none data-[selection-end]:rounded-e-lg data-[selection-start]:rounded-s-lg data-[invalid]:bg-muted data-[selected]:bg-accent data-[selected]:text-foreground data-[invalid]:data-[selection-end]:[&:not([data-hover])]:bg-muted-foreground data-[invalid]:data-[selection-start]:[&:not([data-hover])]:bg-muted-foreground data-[selection-end]:[&:not([data-hover])]:bg-primary data-[selection-start]:[&:not([data-hover])]:bg-primary data-[invalid]:data-[selection-end]:[&:not([data-hover])]:text-background data-[invalid]:data-[selection-start]:[&:not([data-hover])]:text-background data-[selection-end]:[&:not([data-hover])]:text-primary-foreground data-[selection-start]:[&:not([data-hover])]:text-primary-foreground",
